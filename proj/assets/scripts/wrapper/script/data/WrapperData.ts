...
import { GameDataBase } from "../../../../scripts/framework/data/GameDataBase";
...
export default class WrapperData extends GameDataBase<IWrapperData> {
    // ---------- 成員變數 --------------------------------------------------------
    /** 資料所有模組，由資料中心設定 */
    ...
    // private framework = EBundles[EBundles.slotFramework]
    // private game = EBundles[EBundles.g1002]
