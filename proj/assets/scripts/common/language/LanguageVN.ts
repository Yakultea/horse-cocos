...
export let LanguageVN = {
  ...
  data: {
    ...
    newVersion: "檢測到有新的版本，是否更新?",
    noFindManifest: "找不到版本檔案!!!",
    downloadFailManifest: "下載版本檔案失敗!",
    manifestError: "版本檔案解析錯誤!",
    checkingUpdate: "檢測更新中...",
    alreadyRemoteVersion: "{0}已升級到最新",
    restartApp: "{0}更新完成，需要重啟遊戲",
    reconnect: "正在重連...",
    ...
    richtext: "<color=#00ff00>富</c><color=#0fffff>文字</color>",
