...
export default class AudioComponent extends EventComponent {
    ...
    /**@description 音訊控制元件資源擁有者，該物件由UIManager開啟的介面 */
